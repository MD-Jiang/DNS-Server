...
void UDPServer::handleRequest()
{
    ...
    responseHeader.answer_count = 1;
    responseHeader.authority_count = 0;
    responseHeader.additional_count = 0;

    responseHeader.question.qname = requestHeader.question.qname;
    responseHeader.question.qclass = requestHeader.question.qclass;
    ...
    const std::size_t total_length = responseHeader.serialize(responseBuffer);
